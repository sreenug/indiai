...
class College(models.Model):
    ...
    college_accreditated = models.CharField("Is College Accredited", max_length=10, choices=ACCREDITED_CHOICES)
    accreditations = models.ManyToManyField(Accreditation)
    awards = models.ManyToManyField(Award)
    campus_size = models.CharField("Campus Size", max_length=20)
    builtup_area = models.CharField("Built-Up Area", max_length=20)
    distance_railway = models.CharField("Distance to nearest Railway Station", max_length=20)
    distance_bus = models.CharField("Distance to nearest Bust Stop", max_length=20)
    number_labs = models.IntegerField("Number of Labs", max_length=3)
    boys_hostel = models.FloatField("% Boys having Hostel Facility", max_length=5)
    girls_hostel = models.FloatField("% Girls having Hostel Facility", max_length=5)
    playground = models.CharField(max_length=10, choices=ACCREDITED_CHOICES)
    number_sport_centers = models.IntegerField("Number of Sport Centres in College", max_length=3)
    transport_facility = models.CharField("Availability of Transport Facility", max_length=10, choices=ACCREDITED_CHOICES)
    number_buses = models.IntegerField("Number of Buses", max_length=3)
    number_mini_buses = models.IntegerField("Number of Mini-Buses", max_length=3)

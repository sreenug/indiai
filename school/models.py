...
class School(models.Model):
    ...
    teacher_strength = models.IntegerField("Teacher Strength", max_length=10, blank=True, null=True, help_text='Enter only numbers without comma')
    student_strength = models.IntegerField("Student Strength", max_length=10, blank=True, null=True, help_text='Enter only numbers without comma')

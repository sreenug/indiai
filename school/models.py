...
class School(models.Model):
    ...
    management_type = models.CharField("Management Type*", max_length=100, choices=TYPE_CHOICES)
    ...
    phone_number = models.IntegerField("Phone Number", max_length=12, null=True, blank=True)
